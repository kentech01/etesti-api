...
export class InitialSchema1700000000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "exams" ADD CONSTRAINT "FK_exams_sector" FOREIGN KEY ("sectorId") REFERENCES "sectors"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);

        await queryRunner.query(`ALTER TABLE "questions" ADD CONSTRAINT "FK_questions_exam" FOREIGN KEY ("examId") REFERENCES "exams"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);

        await queryRunner.query(`ALTER TABLE "question_options" ADD CONSTRAINT "FK_options_question" FOREIGN KEY ("questionId") REFERENCES "questions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);

        await queryRunner.query(`ALTER TABLE "user_answers" ADD CONSTRAINT "FK_answers_user" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);

        await queryRunner.query(`ALTER TABLE "user_answers" ADD CONSTRAINT "FK_answers_exam" FOREIGN KEY ("examId") REFERENCES "exams"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);

        await queryRunner.query(`ALTER TABLE "user_answers" ADD CONSTRAINT "FK_answers_question" FOREIGN KEY ("questionId") REFERENCES "questions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);

        await queryRunner.query(`ALTER TABLE "user_answers" ADD CONSTRAINT "FK_answers_option" FOREIGN KEY ("selectedOptionId") REFERENCES "question_options"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user_answers" DROP CONSTRAINT "FK_answers_option"`);
        await queryRunner.query(`ALTER TABLE "user_answers" DROP CONSTRAINT "FK_answers_question"`);
        await queryRunner.query(`ALTER TABLE "user_answers" DROP CONSTRAINT "FK_answers_exam"`);
        await queryRunner.query(`ALTER TABLE "user_answers" DROP CONSTRAINT "FK_answers_user"`);
        await queryRunner.query(`ALTER TABLE "question_options" DROP CONSTRAINT "FK_options_question"`);
        await queryRunner.query(`ALTER TABLE "questions" DROP CONSTRAINT "FK_questions_exam"`);
        await queryRunner.query(`ALTER TABLE "exams" DROP CONSTRAINT "FK_exams_sector"`);
